...
{ private  $encoder;
    ...
    $peinturesMini=[];
    $peinturesMini[]="build/Alberto_Sanchez_De_un_punto_mini.jpg";
    $peinturesMini[]="build/angel_ferrant_mini.jpg";
    $peinturesMini[]="build/eurgal_paysage_marin_mini.jpg";
    $peinturesMini[]="build/eurgal-_mini.jpg";
    $peinturesMini[]="build/eurgal-2_mini.jpg";
    $peinturesMini[]="build/eurgal-3_mini.jpg";
    $peinturesMini[]="build/eurgal-4_mini.jpg";
    $peinturesMini[]="build/eurgal-5_mini.jpg";
    $peinturesMini[]="build/gaugin_mini.jpg";
    $peinturesMini[]="build/giacometti_mini.jpg";
    $peinturesMini[]="build/Jacques_Lipchitz_1918_Guitariste_mini.jpg";
    $peinturesMini[]="build/julio-golzalez_mini.jpg";
    $peinturesMini[]="build/miquel_barcelo_pinassi_mini.jpg";
    $peinturesMini[]="build/paul-henry_turn-of-the-road_mini.jpg";
    $peinturesMini[]="build/rafael-ruiz-balerdi_mini.jpg";
    $peinturesMini[]="build/soulage_mini.jpg";
    $peintures=[];
    $peintures[]="build/Alberto_Sanchez_De_un_punto.jpg";
    $peintures[]="build/angel_ferrant.jpg";
    $peintures[]="build/eurgal_paysage_marin.jpg";
    $peintures[]="build/eurgal-.jpg";
    $peintures[]="build/eurgal-2.jpg";
    $peintures[]="build/eurgal-3.jpg";
    $peintures[]="build/eurgal-4.jpg";
    $peintures[]="build/eurgal-5.jpg";
    $peintures[]="build/gaugin.jpg";
    $peintures[]="build/giacometti.jpg";
    $peintures[]="build/Jacques_Lipchitz_1918_Guitariste.jpg";
    $peintures[]="build/julio-golzalez.jpg";
    $peintures[]="build/miquel_barcelo_pinassi.jpg";
    $peintures[]="build/paul-henry_turn-of-the-road.jpg";
    $peintures[]="build/rafael-ruiz-balerdi.jpg";
    $peintures[]="build/soulage.jpg";
    $typesProduit=[];
    ...
    for($j=1;$j<=20;$j++){
        ...
        for($k=1;$k<=10;$k++){
            ...
            $produit->setPhotographie("build/tshirt.jpg");
            $produit->setMiniature("build/tshirt.jpg");
            ...
            $produit->setQuantiteStocks(1);
            $produit->setQuantiteVendue(0);
            $produit->setPhotographie("build/postcard.jpg");
            $produit->setMiniature("build/postcard.jpg");
            $produit->setArtiste($artiste);
            $produit->setProduitoriginal($oeuvre);
