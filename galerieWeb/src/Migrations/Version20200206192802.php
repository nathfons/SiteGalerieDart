 ...
 */
final class Version20200206192802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, id_client_id INT DEFAULT NULL, ville VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, rue_et_numero VARCHAR(255) NOT NULL, INDEX IDX_C35F081699DED506 (id_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE artiste (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, biography LONGTEXT NOT NULL, approuve TINYINT(1) NOT NULL, photographie VARCHAR(255) DEFAULT NULL, miniature VARCHAR(255) DEFAULT NULL, commission DOUBLE PRECISION NOT NULL, alaune TINYINT(1) NOT NULL, text_alaune LONGTEXT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, date_creation_compte DATETIME NOT NULL, UNIQUE INDEX UNIQ_9C07354FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, date_creation_compte DATETIME NOT NULL, UNIQUE INDEX UNIQ_C7440455FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, id_adresse_id INT DEFAULT NULL, id_typelivraison_id INT DEFAULT NULL, id_typepaiement_id INT DEFAULT NULL, id_client_id INT DEFAULT NULL, referencecommande VARCHAR(50) NOT NULL, etatcommande VARCHAR(50) NOT NULL, datecommande DATETIME NOT NULL, datelivraison DATETIME DEFAULT NULL, INDEX IDX_6EEAA67DE86D5C8B (id_adresse_id), INDEX IDX_6EEAA67D787ACB9B (id_typelivraison_id), INDEX IDX_6EEAA67DBD5AA1AD (id_typepaiement_id), INDEX IDX_6EEAA67D99DED506 (id_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE couleur (id INT AUTO_INCREMENT NOT NULL, nomcouleur VARCHAR(10) NOT NULL, code_hexadecimal VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE paragraphe (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, photo_id INT DEFAULT NULL, contenu LONGTEXT DEFAULT NULL, INDEX IDX_4C1BA9B67294869C (article_id), INDEX IDX_4C1BA9B67E9E4C8C (photo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, cadre_id INT DEFAULT NULL, artiste_id INT DEFAULT NULL, produitoriginal_id INT DEFAULT NULL, categorie_id INT NOT NULL, type_produit VARCHAR(50) NOT NULL, nom_produit VARCHAR(100) NOT NULL, date_creation DATETIME NOT NULL, descriptif LONGTEXT NOT NULL, dimension VARCHAR(255) NOT NULL, prix_ht DOUBLE PRECISION DEFAULT NULL, approuve TINYINT(1) NOT NULL, remise DOUBLE PRECISION NOT NULL, poids DOUBLE PRECISION NOT NULL, en_vente TINYINT(1) DEFAULT NULL, en_stock TINYINT(1) DEFAULT \'0\', quantite_stocks DOUBLE PRECISION DEFAULT NULL, quantite_vendue DOUBLE PRECISION DEFAULT NULL, photographie VARCHAR(255) NOT NULL, miniature VARCHAR(255) NOT NULL, dimension_cadre VARCHAR(255) DEFAULT NULL, INDEX IDX_29A5EC279308DA90 (cadre_id), INDEX IDX_29A5EC2721D25844 (artiste_id), INDEX IDX_29A5EC27DAF8BCE7 (produitoriginal_id), INDEX IDX_29A5EC27BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX IDX_1D1C63B3C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC279308DA90 FOREIGN KEY (cadre_id) REFERENCES cadre (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC2721D25844 FOREIGN KEY (artiste_id) REFERENCES artiste (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27DAF8BCE7 FOREIGN KEY (produitoriginal_id) REFERENCES produit (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE artiste_categorie_artiste DROP FOREIGN KEY FK_3C66806B21D25844');
        ...
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC279308DA90');
        ...
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC27DAF8BCE7');
