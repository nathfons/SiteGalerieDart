 ...
 */
final class Version20200107162605 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE artiste (id INT AUTO_INCREMENT NOT NULL, biography VARCHAR(10000) NOT NULL, approuve TINYINT(1) NOT NULL, photographie VARCHAR(255) DEFAULT NULL, miniature VARCHAR(255) DEFAULT NULL, commission DOUBLE PRECISION NOT NULL, alaune TINYINT(1) NOT NULL, text_alaune LONGTEXT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, date_creation_compte DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cadre (id INT AUTO_INCREMENT NOT NULL, id_couleur_id INT DEFAULT NULL, id_matiere_id INT NOT NULL, imagecadre VARCHAR(255) NOT NULL, prix_cadre_unite_ht DOUBLE PRECISION NOT NULL, INDEX IDX_F42587B9669125A1 (id_couleur_id), INDEX IDX_F42587B951E6528F (id_matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE paragraphe (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, text VARCHAR(1000) DEFAULT NULL, INDEX IDX_4C1BA9B67294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cadre ADD CONSTRAINT FK_F42587B9669125A1 FOREIGN KEY (id_couleur_id) REFERENCES couleur (id)');
        $this->addSql('ALTER TABLE cadre ADD CONSTRAINT FK_F42587B951E6528F FOREIGN KEY (id_matiere_id) REFERENCES matiere (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cadre DROP FOREIGN KEY FK_F42587B9669125A1');
        $this->addSql('ALTER TABLE cadre DROP FOREIGN KEY FK_F42587B951E6528F');
